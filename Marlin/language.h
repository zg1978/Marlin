...
//#define LANGUAGE_INCL_(M) STRINGIFY_(language_##M.h)  ///20180120
//#define LANGUAGE_INCL(M) LANGUAGE_INCL_(M)
//#define INCLUDE_LANGUAGE LANGUAGE_INCL(cn)
...
//const buttontext *btDefult;
const buttontext btChinese{
  "prepareCN",
  };

  const buttontext btEnglish{
    "prepareEN",
    };
